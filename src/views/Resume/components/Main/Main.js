      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          ...
          <ul style={{marginLeft: "2em"}}>
            <li>
              <Typography variant="h6" gutterBottom color="textPrimary">
              Conducted market research on 895 crypto projects to define their function, project-type classification, and blockchain ecosystem.
              </Typography>
            </li>
            <li>
              <Typography variant="h6" gutterBottom color="textPrimary">
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          ...
          <ul style={{marginLeft: "2em"}}>            
            <li>
              <Typography variant="h6" gutterBottom color="textPrimary">
                Duration: [Began December 7th, 2020; 60% Complete]
              </Typography>
            </li>
          </ul>
        </Grid>
